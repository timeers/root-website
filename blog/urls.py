...
urlpatterns = [
    ...
    path('hireling/<int:pk>/', HirelingDetailView.as_view(), name='hireling-detail'),
    path('landmark/<int:pk>/', LandmarkDetailView.as_view(), name='landmark-detail'),
    path('vagabond/<int:pk>/', VagabondDetailView.as_view(), name='vagabond-detail'),
    path('faction/<int:pk>/', FactionDetailView.as_view(), name='faction-detail'),
    ...
    path('map/<int:pk>/update/', MapUpdateView.as_view(), name='map-update'),
    path('deck/<int:pk>/update/', DeckUpdateView.as_view(), name='deck-update'),
    path('hireling/<int:pk>/update/', HirelingUpdateView.as_view(), name='hireling-update'),
    path('landmark/<int:pk>/update/', LandmarkUpdateView.as_view(), name='landmark-update'),
    path('vagabond/<int:pk>/update/', VagabondUpdateView.as_view(), name='vagabond-update'),
    path('faction/<int:pk>/update/', FactionUpdateView.as_view(), name='faction-update'),
