...
from .views import (profile, player_page_view, 
                    designer_component_view, post_bookmarks, game_bookmarks, player_games, onboard_user, player_stats, artist_component_view)
...
urlpatterns = [
    ...
    path('<slug:slug>/game-list/', player_games, name='player-games'),
