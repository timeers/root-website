...
from .views import (user_settings, player_page_view, dwd_profile_redirect,
                    ...
                    woodland_warriors_info, databot_info, databot_add, databot_added, set_global_message, send_notification,
...
urlpatterns = [
    ...
    path('feedback/forge/', forge_feedback, name='forge-feedback'),
    path('feedback/forge/faction/<int:pk>/', forge_faction_feedback, name='forge-faction-feedback'),
    ...
    path('databot/add/', databot_add, name='databot-add'),
    path('databot/added/', databot_added, name='databot-added'),
    ...
    path("guild/<str:guild_id>/request/", guild_join_request, name="guild-request",),
    path("guild/<str:guild_id>/invite/", guild_invite_view, name="guild-invite"),
    path('guild/<str:guild_id>/mark-invite-clicked/', mark_guild_invite_clicked, name='mark-guild-invite-clicked'),
    ...
    path('guild/<str:guild_id>/edit/', edit_guild, name='edit-guild'),
    path('guild/<str:guild_id>/lfg-role/add/', hx_save_lfg_role, name='guild-lfg-role-add'),
