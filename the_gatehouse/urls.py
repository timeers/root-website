...
from .views import (user_settings, player_page_view, dwd_profile_redirect,
                    ...
                    discord_notification_settings, availability_settings, availability_compare,
                    availability_week_data, availability_save, availability_compare_week_data,
                    steam_link_start, steam_link_callback, steam_unlink,
...
urlpatterns = [
    ...
    path('availability/', availability_settings, name='availability'),
    path('availability/week-data/', availability_week_data, name='availability-week-data'),
    path('availability/save/', availability_save, name='availability-save'),
    path('availability/compare/', availability_compare, name='availability-compare'),
    path('availability/compare/week-data/', availability_compare_week_data, name='availability-compare-week-data'),
    path('settings/generate-api-key/', generate_api_key, name='generate-api-key'),
    path('settings/steam/link/', steam_link_start, name='steam-link-start'),
    path('settings/steam/callback/', steam_link_callback, name='steam-link-callback'),
    path('settings/steam/unlink/', steam_unlink, name='steam-unlink'),
