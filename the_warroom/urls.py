...
from .views import (game_list_view, leaderboard_view,
                    ...
                    bookmark_game,
                    manage_game, import_box_score, about_series_view, about_games_view,
                    ...
                    tournament_players_export, tournament_players_import,
                    stage_players_export, stage_players_import,
                    ...
                    round_create_game_threads, match_link_game,
...
urlpatterns = [
    ...
    # Legacy /v2/ aliases -- kept so bookmarks and links already sent into
    # Discord channels keep resolving. Safe to remove once traffic drops off.
    path('record/game/v2/', manage_game, name='record-game-v2'),
    path("game/<int:id>/edit/v2/", manage_game, name='game-update-v2'),
    path('record/game/import-box-score/', import_box_score, name='import-box-score'),
    path("match/<int:match_id>/link-game/", match_link_game, name='match-link-game'),
    ...
    path('series/<slug:tournament_slug>/stage/<slug:stage_slug>/players/export/', stage_players_export, name='stage-players-export'),
    path('series/<slug:tournament_slug>/stage/<slug:stage_slug>/players/import/', stage_players_import, name='stage-players-import'),
