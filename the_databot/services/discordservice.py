...
# The user's OAuth identity lives in the_gatehouse — send_discord_dm resolves a
# Discord id from a linked SocialAccount, and user_can_manage_guild needs the
# user's own token alongside the bot's. Safe at module level: discord_oauth
# imports only the_gatehouse.models, which this module already imports above.
from the_gatehouse.services.discord_oauth import get_discord_id, get_valid_discord_token
