...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'the_gatehouse.context_processors.active_user_data',
            ],
        },
    },
]
...
PWA_CACHE_VERSION = config.get('PWA_CACHE_VERSION', 'dev')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'the_warroom.api.authentication.ProfileApiKeyAuthentication',
