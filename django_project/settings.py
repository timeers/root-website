...
SECRET_KEY = 'django-insecure-ft%)wju6w7+n+*d04a0bd3=ei+o2hhu=gfw#ydeoohb#hy!an2'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('ROOTDB_USER')
EMAIL_HOST_PASSWORD = os.environ.get('ROOTDB_PASS')
